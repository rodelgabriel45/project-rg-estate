...
export default function Search() {
  ...
  const onShowMoreClick = async () => {
    const numberOflistings = listingsResult.length;
    ...
    setListingsResult([...listingsResult, ...resData]);
  };
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1">
        ...
        <div className="p-7 md:flex gap-5 flex-wrap">
          {loading && (
            <p className="text-xl font-semibold text-center">
              Loading results...
            </p>
          )}
          {!loading && listingsResult.length === 0 && (
            <p className="text-xl font-semibold ">No listing found!</p>
          )}
          {!loading &&
            listingsResult &&
